...
#' @param x a vector of latency covariates that is used to estimate survival or hazard rates. If \code{x = NULL}, the baseline survival or hazard will be predicted.
#' @details
